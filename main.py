...
Ghalad3 = f"Ghalad: Hello, {name}! I was just chasing some monsters that ran off with another hero. Have you seen {bright_yellow}Artimas{white}? (escuse me, I didn't come up with the names)"

Ghalad4 = f"Ghalad: Oh! There they are, those morbid little monsters! You are coming to chase them with me! (hashtag " \
          f"Forceful)"  # hashtag forceful
